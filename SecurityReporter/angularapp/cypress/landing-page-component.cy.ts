...
function CheckFooterLink(divNumber: number, linkNumber: number, text: string) {
...
function CheckFooterAElement(linkNumber: number, text: string) {
...
function CheckFooterElements() {
  ...
  cy.get('p#footer_more_info').contains('Siemens Healthcare GmbH © 2023').should('exist').and('be.visible');
}
