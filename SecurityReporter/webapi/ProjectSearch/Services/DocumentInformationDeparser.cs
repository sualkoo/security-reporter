...
{
    public class DocumentInformationDeparser
    {
        public void createDocumentInformation(DocumentInformation documentInformation)
        {
            ...
            foreach (ReportVersionEntry rve in documentInformation.ReportDocumentHistory)
            {
                ...
                string entryString = "\t\\ReportVersionEntry{" + rve.VersionDate.ToShortDateString() + "}{" + rve.Version + "}{" + rve.WholeName + "}{" + rve.ReportStatus + "}";
