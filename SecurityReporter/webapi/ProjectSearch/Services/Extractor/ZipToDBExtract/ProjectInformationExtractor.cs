...
{
    private readonly ProjectInformation newProjectInfo = new();
    private readonly Dictionary<string, ProjectInformationParticipant> pentestTeamDictionary;
    private bool pentestTeamMember = false;
    private readonly ZipArchiveEntry projectInfoEntry;
    private bool technicalContacts = false;
